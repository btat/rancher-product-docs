...
. xref:rancher-admin/users/settings/api-keys.adoc#_creating_an_api_key[Create] 
endif::[]
ifeval::["{build-type}" == "community"]
. xref:reference-guides/user-settings/api-keys.adoc#_creating_an_api_key[Create] 
endif::[]
a Rancher API key with no scope.
...
In this example, we'll show how to use kubectl to create a project, followed by deleting it. For a list of other Rancher resources available, refer to the
ifeval::["{build-type}" == "product"]
