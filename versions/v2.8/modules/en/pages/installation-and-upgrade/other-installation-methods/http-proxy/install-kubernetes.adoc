...
For more information on installing K3s see the https://documentation.suse.com/cloudnative/k3s/latest/en/installation[K3s installation docs].
...
== xref:installation-and-upgrade/other-installation-methods/http-proxy/install-rancher.adoc[Next: Install Rancher]
