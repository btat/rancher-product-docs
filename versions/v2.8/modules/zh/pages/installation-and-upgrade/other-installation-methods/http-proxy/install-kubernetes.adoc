...
有关安装 K3s 的更多信息，请参阅 https://documentation.suse.com/cloudnative/k3s/latest/zh/installation[K3s 安装文档]。
...
[#_离线代理]
[pass]
<h3><a class="anchor" id="_离线代理" href="#_离线代理"></a>离线代理</h3>
...
[#_创建_rke_集群]
[pass]
<h3><a class="anchor" id="_创建_rke_集群" href="#_创建_rke_集群"></a>创建 RKE 集群</h3>
...
[#_保存你的文件]
[pass]
<h3><a class="anchor" id="_保存你的文件" href="#_保存你的文件"></a>保存你的文件</h3>
