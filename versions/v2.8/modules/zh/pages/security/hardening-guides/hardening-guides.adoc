...
* https://documentation.suse.com/cloudnative/k3s/latest/zh/[*K3s*] 是一个完全合规的，轻量级 Kubernetes 发行版。它易于安装，内存需求只有上游 Kubernetes 的一半，所有组件都在一个小于 100 MB 的二进制文件中。
...
| CIS v1.23
| https://documentation.suse.com/cloudnative/k3s/latest/zh/security/self-assessment[链接]
| https://documentation.suse.com/cloudnative/k3s/latest/zh/security/hardening-guide[链接]
|===
