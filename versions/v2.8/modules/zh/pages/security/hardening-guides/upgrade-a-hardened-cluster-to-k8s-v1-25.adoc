...
遵循 K3s https://documentation.suse.com/cloudnative/k3s/latest/zh/known-issues#hardened-125[将加固集群从 v1.24.x 升级到 v1.25.x]的官方说明，但使用xref:shared:ROOT:attachment$rancher-psact.yaml[自定义]Rancher PSA 配置模板，而不是 K3s 官方网站上提供的配置。
--
======
